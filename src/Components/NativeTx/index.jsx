...
function NativeTx() {
  ...
  async function getFee() {
    ...
    const apiRes = await connectionObj.initializeApi(
      auth.wsEndPoints.testnet,
      auth.wsEndPoints.qa,
      auth.wsEndPoints.uat,
      auth.currentNetwork,
      false,
    )
    if (!apiRes?.value) {
    ...
    switch (auth?.uiData?.method) {
      ...
      case 'native_nominator_payout':
        feeData = await nominatorValidatorPayout(
          apiRes.nativeApi,
          auth?.uiData?.message,
          true,
        )
      ...
      case 'native_stop_validator':
        feeData = await stopValidatorNominator(
          apiRes.nativeApi,
          auth?.uiData?.message,
          true,
        )
      ...
      case 'native_unbond_validator':
        feeData = await unbondNominatorValidator(
          apiRes.nativeApi,
          auth?.uiData?.message,
          true,
        )
      ...
      case 'native_withdraw_nominator':
        feeData = await withdrawNominatorValidatorData(
          apiRes.nativeApi,
          auth?.uiData?.message,
          true,
        )
      ...
      case 'native_withdraw_nominator_unbonded':
        feeData = await withdrawNominatorUnbonded(
          apiRes.nativeApi,
          auth?.uiData?.message,
          true,
        )
      ...
      case 'native_restart_validator':
        feeData = await restartValidator(
          apiRes.nativeApi,
          auth?.uiData?.message,
          true,
        )
  ...
  function handleClick(isApproved) {
    if (isApproved) {
      ...
      connectionObj
        .initializeApi(
          auth.httpEndPoints.testnet,
          auth.httpEndPoints.qa,
          auth.httpEndPoints.uat,
          auth.currentNetwork,
          false,
        )
        .then(async (apiRes) => {
          ...
          switch (method) {
            ...
            case 'native_renominate':
              ...
              break
            case 'native_nominator_payout':
              res = await nominatorValidatorPayout(
                apiRes.nativeApi,
                auth?.uiData?.message,
              )
              break
            ...
            case 'native_stop_nominator':
              ...
              break
            case 'native_unbond_validator':
              res = await unbondNominatorValidator(
                apiRes.nativeApi,
                auth?.uiData?.message,
              )
              break
            ...
            case 'native_unbond_nominator':
              ...
              break
            case 'native_withdraw_nominator':
              res = await withdrawNominatorValidatorData(
                apiRes.nativeApi,
                auth?.uiData?.message,
              )
              break
            ...
            case 'native_withdraw_validator':
              ...
              break
            case 'native_withdraw_nominator_unbonded':
              res = await withdrawNominatorUnbonded(
                apiRes.nativeApi,
                auth?.uiData?.message,
              )
              break
          ...
          if (res?.error) {
            ...
            let dataToDispatch = {
              ...
              index: auth?.accounts.findIndex(
                (obj) => obj.id === auth?.currentAccount?.id,
              ),
            }
            ...
            Browser.runtime.sendMessage({
              type: 'tx',
              ...dataToDispatch,
              statusCheck: { isFound: false, status: STATUS.PENDING },
            })
              ...
              <div className={pageStyle.rejectedSec__detailDataSec}>
                ...
                <div className={pageStyle.rejectedSec__listReject}>
                  <div className={pageStyle.rejectedSec__listReject__innerList}>
                    ...
                    <h4>
                      {shortLongAddress(
                        String(auth?.currentAccount?.nativeAddress),
                      )}
                    </h4>
                  </div>
                  <div className={pageStyle.rejectedSec__listReject__innerList}>
