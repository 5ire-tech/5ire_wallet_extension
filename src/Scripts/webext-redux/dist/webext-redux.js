    ...
    return function (message) {
      ...
      if (shouldDeserialize.apply(void 0, [message].concat(args))) {
        return listener.apply(
          void 0,
          [transformPayload(message, deserializer)].concat(args),
        )
      }
          ...
          return new Promise(function (resolve, reject) {
            _this3.serializedMessageSender(
              ...
              function (resp) {
                ...
                if (error) {
                  var _bgErr = new Error(
                    ''.concat(backgroundErrPrefix).concat(error),
                  )
...
function applyMiddleware(store) {
  for (
    var _len2 = arguments.length,
      middlewares = new Array(_len2 > 1 ? _len2 - 1 : 0),
      _key2 = 1;
    _key2 < _len2;
    _key2++
  ) {
...
var wrapStore = function (store) {
  var _ref =
    ...
    _ref$portName = _ref.portName,
    portName =
      _ref$portName === void 0 ? defaultOpts$1.portName : _ref$portName,
    _ref$dispatchResponde = _ref.dispatchResponder,
    dispatchResponder =
      _ref$dispatchResponde === void 0
        ? defaultOpts$1.dispatchResponder
        : _ref$dispatchResponde,
    _ref$serializer = _ref.serializer,
    serializer =
      _ref$serializer === void 0 ? defaultOpts$1.serializer : _ref$serializer,
    _ref$deserializer = _ref.deserializer,
    deserializer =
      _ref$deserializer === void 0
        ? defaultOpts$1.deserializer
        : _ref$deserializer,
    _ref$diffStrategy = _ref.diffStrategy,
    diffStrategy =
      _ref$diffStrategy === void 0
        ? defaultOpts$1.diffStrategy
        : _ref$diffStrategy
  ...
  var dispatchResponse = function dispatchResponse(
    request,
    sender,
    sendResponse,
  ) {
  ...
  withPayloadDeserializer(function () {
    ...
    return (_browserAPI$runtime$o =
      browserAPI.runtime.onMessage).addListener.apply(
  ...
  if (browserAPI.runtime.onMessageExternal) {
    withPayloadDeserializer(function () {
      ...
      return (_browserAPI$runtime$o2 =
        browserAPI.runtime.onMessageExternal).addListener.apply(
