...
},balance:{evmBalance:"",nativeBalance:"",totalBalance:""},currentNetwork:"QA",// currentNetwork: "QA",
...
_context12.next=27;return this.platform.openWindow({url:extensionURL+"?route=".concat(route),type:"popup",width:NOTIFICATION_WIDTH,height:NOTIFICATION_HEIGHT,left:left,top:top});case 27:popupWindow=_context12.sent;if(!(popupWindow.left!==left&&popupWindow.state!=="fullscreen")){_context12.next=31;break;}_context12.next=31;return this.platform.updateWindowPosition(popupWindow.id,left,top);case 31:this._popupId=popupWindow.id;case 32:case"end":return _context12.stop();}},_callee12,this,[[11,19]]);}));function showPopup(){return _showPopup.apply(this,arguments);}return showPopup;}()},{key:"_onWindowClosed",value:function _onWindowClosed(windowId){// console.log("Yyyyyyyy", windowId, this._popupId)
if(windowId===this._popupId){this._popupId=undefined;// this.emit("POPUP_CLOSED", {
//   automaticallyClosed: this._popupAutomaticallyClosed,
// });
this._popupAutomaticallyClosed=undefined;this.handleClose();}}},{key:"handleClose",value:function handleClose(){var _state$auth$uiData,_state$auth$uiData$me;var state=this.store.getState();var method=state===null||state===void 0?void 0:(_state$auth$uiData=state.auth.uiData)===null||_state$auth$uiData===void 0?void 0:(_state$auth$uiData$me=_state$auth$uiData.message)===null||_state$auth$uiData$me===void 0?void 0:_state$auth$uiData$me.method;var conntectMethods=["eth_requestAccounts","eth_accounts","connect"];// console.log("I WAS WAITING FOR MESSAGE")
if(conntectMethods.indexOf('method')>-1){var _state$auth,_state$auth$uiData2,_state$auth$uiData3;browser_polyfill_default().tabs.sendMessage(state===null||state===void 0?void 0:(_state$auth=state.auth)===null||_state$auth===void 0?void 0:(_state$auth$uiData2=_state$auth.uiData)===null||_state$auth$uiData2===void 0?void 0:_state$auth$uiData2.tabId,{id:state===null||state===void 0?void 0:(_state$auth$uiData3=state.auth.uiData)===null||_state$auth$uiData3===void 0?void 0:_state$auth$uiData3.id,response:null,error:"User rejected connect permission."});}else if(method==='eth_sendTransaction'){var _state$auth2,_state$auth2$uiData,_state$auth3,_state$auth3$uiData;browser_polyfill_default().tabs.sendMessage(state===null||state===void 0?void 0:(_state$auth2=state.auth)===null||_state$auth2===void 0?void 0:(_state$auth2$uiData=_state$auth2.uiData)===null||_state$auth2$uiData===void 0?void 0:_state$auth2$uiData.tabId,{id:state===null||state===void 0?void 0:(_state$auth3=state.auth)===null||_state$auth3===void 0?void 0:(_state$auth3$uiData=_state$auth3.uiData)===null||_state$auth3$uiData===void 0?void 0:_state$auth3$uiData.id,response:null,error:"User rejected  transactoin."});}this.store.dispatch(setUIdata({}));}/**
